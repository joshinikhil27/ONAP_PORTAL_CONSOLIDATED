					...
					<div class="panel panel-default">
						...
						<div class="panel-body text-light">
							<div class="stat-panel text-right">
								...
								<div class="stat-panel-title text-uppercase {{colorCode[value]}}">{{value}}</div>
							</div>
						</div>
					</div>
				</a>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="col-lg-4">
						<div class="panel panel-info">
							<div class="panel-heading panel1">
								<span class="pull-left panelheading1">New User Analysis </span>
								<div class="clearfix"></div>
							</div>
							<div class="panel-body">
								<div id="graph4"></div>
					...
					<div class="col-lg-4">
						<div class="panel panel-info">
							<div class="panel-heading panel1">
								<span class="pull-left panelheading1">Number Of Connection
									Analysis </span>
								<div class="clearfix"></div>
							</div>
							<div class="panel-body">
