			...
			<div class="panel panel-default panelBodyBg">
				...
				<div class="panel-body">
					...
					<div class="col-md-4 colBg">
						...
						<div ng-repeat="(index1 , data) in paramCompare1">
					...
					<div class="col-md-4 colBg">
						<label class="text-primary" style="font-size: 17px;margin-bottom:8px;margin-left: 99px;margin-top: 9px;">Version  {{firstversion}}</label>
						<div ng-repeat="(index1,data) in paramCompare1">
					...
					<div class="col-md-4 colBg">
						<label class="text-primary" style="font-size: 17px; margin-bottom:8px ; margin-left: 99px; margin-top: 9px;">Version  {{secondversion}}</label>
						<div ng-repeat="(index1,data) in paramCompare2">
							<div  ng-repeat="(key,value) in data">
								<div ng-if="key == 'date'">
									<hr ng-if="index1==1" class="hr5Black">
									<hr ng-if="index1!=1" class="hr1Gray">
