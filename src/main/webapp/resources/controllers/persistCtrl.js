        ...
        return {
            ...
            scope : {
             ...
             template : '<div class="modal fade persistmodal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">'
                ...
                + '<img alt="" src="resources/images/Restart-VM_Normal.png" ng-click="btnclick()">'
                + '<p>Restart VM</p>'
                + '</div>'
                + '<div class="col-md-4" style="top: 8px;">'
                + '<img alt="" src="resources/images/Rebuild-VM_Normal.png" ng-click="btnclick()">'
                + '<p>Rebuild VM</p>'
                + '</div>'
                + '<div class="col-md-4" style="top: 15px;">'
                + '<img alt="" src="resources/images/Raise_Ticket_Normal.png" ng-click="btnclick()">'
                + '<p>Raise Ticket</p>'
                + '</div>'						
                + '</div>'
                + '<div class="col-md-5">'
